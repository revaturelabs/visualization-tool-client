...
describe('CategoryComponent', () => {
  ...
  beforeEach(() => {
    CATEGORIES = [
      { categoryID: 1, categoryName: 'TestCategory1', cateogryDescription: 'Testing this Category 1', categoryColor: '#FF5733' },
      { categoryID: 2, categoryName: 'TestCategory2', cateogryDescription: 'Testing this Category 2', categoryColor: '#335733' },
      { categoryID: 3, categoryName: 'TestCategory3', cateogryDescription: 'Testing this Category 3', categoryColor: '#265733' }
    ];
