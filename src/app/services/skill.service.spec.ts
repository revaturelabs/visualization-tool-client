...
describe('SkillService', () => {
  ...
  it('should add new skill', inject(
    [HttpTestingController, SkillService],
  ...
  //
  it('should get all skill', inject(
    [HttpTestingController, SkillService],
